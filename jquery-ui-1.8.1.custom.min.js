...
$.widget("ui.dialog", {
	...
	_create: function() {
		...
		var self = this,
			...
			uiDialogWrapper = (self.uiDialogWrapper = $('<div></div>'))
				.addClass(
					'ui-dialog-wrapper ')
				.appendTo(uiDialog),
/*				
			uiDialogWrapper02 = (self.uiDialogWrapper02 = $('<div></div>'))
				.addClass(
					'ui-dialog-wrapper02 ')
				.appendTo(uiDialogWrapper01),
			
			uiDialogHeader = (self.uiDialogHeader = $('<div></div>'))
				.addClass(
					'ui-dialog-header ')
				.prependTo(uiDialog),	
			
			uiDialogHeaderLeft = (self.uiDialogHeaderLeft = $('<div><img src="../img/dialog-top-left-shadow.png" /></div>'))
				.addClass(
					'ui-dialog-header-left ')
				.appendTo(uiDialogHeader),
				
			uiDialogHeaderRight = (self.uiDialogHeaderRight = $('<div><img src="../img/dialog-top-right-shadow.png" /></div>'))
				.addClass(
					'ui-dialog-header-right ')
				.appendTo(uiDialogHeader),
			
			uiDialogHeaderCenter = (self.uiDialogHeaderCenter = $('<div></div>'))
				.addClass(
					'ui-dialog-header-center ')
				.appendTo(uiDialogHeader),
				
			uiDialogFooter = (self.uiDialogFooter = $('<div></div>'))
				.addClass(
					'ui-dialog-footer ')
				.appendTo(uiDialog),	
*/			
